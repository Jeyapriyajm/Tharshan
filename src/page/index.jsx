        ...
        <div className="mx-auto" style={{ maxWidth: "1100px" }}>
          ...
          <div className="space-y-10 md:space-y-12">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  style={{ color: "#ffd138", fontSize: "0.875rem", textDecoration: "underline" }}
            ...
            >
              ...
              <p style={{ color: "#9a9aa3" }}>
                Gained a solid foundation in Python programming, covering syntax,
                logic building, and problem-solving for real-world applications.
              </p>
              <div className="flex items-center gap-2">
                <span style={{ color: "#9a9aa3", fontSize: "0.875rem" }}>
                  Code: IvKFd53WYq
            ...
            >
              ...
              <p style={{ color: "#9a9aa3" }}>
                Learned to design intuitive and visually appealing interfaces using
                Figma, focusing on layout, prototyping, and user experience principles.
              </p>
              <a
            ...
            >
              ...
              <p style={{ color: "#9a9aa3" }}>
                Mastered search engine optimization strategies, including keyword
                research, on-page optimization, and analytics to improve website
